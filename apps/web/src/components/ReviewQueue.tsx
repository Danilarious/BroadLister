  ...
  return (
    <section className="review-layout">
      <div className="review-list">
        ...
        {reviews.map((item) => (
          <button className={item.id === selected?.id ? "review-card selected" : "review-card"} key={item.id} onClick={() => onSelect(item)}>
      ...
      <aside className="detail-panel">
        ...
        {selected ? (
          <>
            ...
            <p className="guardrail">Approving applies the proposal through the service layer. Imports never write directly to global tables.</p>
          </>
